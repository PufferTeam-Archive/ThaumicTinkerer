...
public final class ConfigHandler {
    ...
    public static void loadConfig(File configFile) {
        ...
        Property propsoulHeartHeight = config.get(Configuration.CATEGORY_GENERAL, "soulHeart.height", soulHeartHeight);
        propsoulHeartHeight.comment = "The height of the Soul Heart bar. You can change this if you have a mod that adds a bar in that spot.";
        soulHeartHeight = propsoulHeartHeight.getInt(soulHeartHeight);
